...
deepspeed --include localhost:4 --master_port=24997 test.py \
  --version="/data/ironman/jiacheng/final_Omni_Data/ck/finetune_SIDA-7B_ours-0.05_full-dataset_ablation1_obj-loss1" \
  ...
  --precision='bf16' \
  --exp_name="evaluation-SIDA-7B_ours_0.05_full-dataset_ablation1_obj-loss1" \
  --test_only \
  > ./logs/evaluation-SIDA-7B_ours_0.05_full-dataset_ablation1_obj-loss1.log 2>&1
