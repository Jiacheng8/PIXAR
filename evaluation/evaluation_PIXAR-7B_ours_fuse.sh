...
TYPE="flux2_0.05"  # gpt_0.05 | ours_0.05 | gemini3_0.05
...
MAIN_DIR="/data/ironman/jiacheng/final_Omni_Data"
TYPE="gemini_0.05"  # gpt_0.05 | ours_0.05 | gemini3_0.05
VERSION="finetune_PIXAR-7B_ours_fuse"
GPU=1
SEG_PROMPT_MODE="fuse"          # seg_only | text_only | fuse
...
MAIN_DIR="/data/ironman/jiacheng/final_Omni_Data"
TYPE="seed_dream_0.05"  # gpt_0.05 | ours_0.05 | gemini3_0.05
VERSION="finetune_PIXAR-7B_ours_fuse"
GPU=1
SEG_PROMPT_MODE="fuse"          # seg_only | text_only | fuse
...
MAIN_DIR="/data/ironman/jiacheng/final_Omni_Data"
TYPE="qwen_dream_0.05"  # gpt_0.05 | ours_0.05 | gemini3_0.05
VERSION="finetune_PIXAR-7B_ours_fuse"
GPU=1
SEG_PROMPT_MODE="fuse"          # seg_only | text_only | fuse
