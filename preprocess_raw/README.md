...
If you prefer to build the dataset from scratch, follow these two steps:

1. **Download raw data** — go to `1_download-data/` and follow the instructions in its `README.md`.
2. **Construct the dataset** — go to `2_construct_dataset/` and follow the instructions in its `README.md`.
